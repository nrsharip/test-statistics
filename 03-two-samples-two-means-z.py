...
text0 = ax.text(POP_2_MEAN + 2*POP_2_STD, POP_2_PROB_MAX * 0.5, f'', fontsize=12)
...
for x in range(NUMBER_OF_TESTS):
    ...
    # Using Populations Std Deviations
    moe = z_alpha * math.sqrt(POP_1_STD**2/SAMPLE_1_SIZE + POP_2_STD**2/SAMPLE_2_SIZE)
    ...
    # Dots
    dots0.set_data(sample1, stats.norm.pdf(sample1, loc = POP_1_MEAN, scale = POP_1_STD))
    dots1.set_data(sample2, stats.norm.pdf(sample2, loc = POP_2_MEAN, scale = POP_2_STD))
