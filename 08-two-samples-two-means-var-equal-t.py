...
ax.set_xlim(POP_2_MEAN - 5.0*POP_2_STD, POP_1_MEAN + 5.0*POP_1_STD)
...
for x in range(NUMBER_OF_TESTS):
    ...
    # https://docs.scipy.org/doc/scipy/reference/generated/scipy.stats.t.html
    t_alpha = stats.t.ppf(1 - ALPHA/2, df=SAMPLE_1_SIZE + SAMPLE_2_SIZE - 2) # alpha divide by 2 - two-tailed test

    moe = t_alpha
    moe *= math.sqrt(((SAMPLE_1_SIZE-1)*s1_std**2 + (SAMPLE_2_SIZE-1)*s2_std**2) / (SAMPLE_1_SIZE + SAMPLE_2_SIZE - 2))
    moe *= math.sqrt(1/SAMPLE_1_SIZE + 1/SAMPLE_2_SIZE)
